	...
	return (
		<div >
			<div>
				<div>
				<img
					className={`max-h-[6rem] max-w-[6rem] min-h-[3rem] min-w-[3rem] absolute [transform:rotateY(90deg)] transition-all rounded-[50%] ease-in duration-[250ms] ${toggled && "[transform:rotateY(-0deg)] delay-[250ms]"}`} src={item.img} alt="face" />
				</div>
				<div
